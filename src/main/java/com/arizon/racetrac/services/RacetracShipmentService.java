...
//    JSONObject json = new JSONObject(jsonContent);
//
//    if (!json.has("despatchAdvice")) {
//        log.warn("No despatchAdvice found in shipment file");
//        return;
//    }
//
//    JSONArray despatchAdvices = json.getJSONArray("despatchAdvice");
//
//    for (int i = 0; i < despatchAdvices.length(); i++) {
//        try {
//            JSONObject despatchAdvice = despatchAdvices.getJSONObject(i);
//            processSingleDespatchAdvice(despatchAdvice);
//        } catch (Exception e) {
//            log.error("Error processing despatchAdvice at index {}: {}", i, e.getMessage(), e);
//            // continue with next
//        }
//    }
//   }   
//    private void processSingleDespatchAdvice(JSONObject despatchAdvice) {
//        String customerReference = despatchAdvice.getString("customerReference"); // e.g., STOCK-058540
//        int sourceOrderId = Integer.parseInt(customerReference.split("-")[1]);
//        String storehash = "cr0kczybyx";
//
//        log.info("Processing order: source_order_id={}", sourceOrderId);
//
//        // Fetch order
//        Optional<OCBCOrderTableTransaction> orderOpt =
//                ocbcOrderTransactionRepository.findByStorehashAndSourceOrderId(storehash, sourceOrderId);
...
//        log.info("All line items validated successfully for order_id={}", sourceOrderId);
//
//        // Post shipment and mark completed
//        postShipmentToBigCommerce(storehash, sourceOrderId, orderProducts);
//        markOrderCompleted(storehash, sourceOrderId);
//    }
//
