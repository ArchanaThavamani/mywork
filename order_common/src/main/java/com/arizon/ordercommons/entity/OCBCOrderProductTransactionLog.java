...
@NoArgsConstructor
@AllArgsConstructor
@Table(schema = "commonbc",name = "tbl_order_lineitem_details_ds_log")
public class OCBCOrderProductTransactionLog {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "order_lineitem_details_ds_log_id")
    public Integer orderLineitemDetailsDsLogId;
