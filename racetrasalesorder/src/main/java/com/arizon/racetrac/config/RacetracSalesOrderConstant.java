...
@Data
public class RacetracSalesOrderConstant 
{
	...
	public static final String isSaturdayDeliveryAllowed="true";
	...
	public static final String isCaseSplittingAllowed="true";
	public static final String beginTime="00:01:00.000";
	public static final String endTime="00:01:00.000";
